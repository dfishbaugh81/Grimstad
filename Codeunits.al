codeunit 50102 toDoMgmt
{
    ...
    begin
        if PriceAsset."Price Type" = PriceAsset."Price Type"::Purchase then
            if PriceAsset."Asset Type" = PriceAsset."Asset Type"::"Item Discount Group" then
                IsHandled := true;
    end;
    ...
    begin
        ...
        if needsToModify then
            ProbReqLine.Modify(false);
    end;
        ...
        if RequisitionLine.Type = RequisitionLine.Type::" " then begin
            ...
            if sl.FindLast() then begin
                ...
                if pl.FindFirst() then begin
                    ...
                    while PurchOrderLine.Get(pl."Document Type", pl."Document No.", NextLineNo)
                    do begin
    ...
    begin
        ...
        if ReqLineCheck.FindFirst() then
            repeat
                IsSpecial := true;
                if ReqLineCheck.Type <> ReqLineCheck.Type::" " then
                    IsOnlySpecialComments := false;
