    ...
    fields
    {
        field(50101; ASN; Boolean)
        {
            ...
            begin
                ...
                if shCount > 0 then if Confirm('Would you like to assign existing Sales Orders the ASN flag?', true, true)then begin
                        if SalesHeader.FindFirst()then repeat if SalesHeader.Status = SalesHeader.Status::Open then begin
