    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                column(RemitToAdd1; RemitToAdd1)
                {
                }
                column(RemitToAdd2; RemitToAdd2)
                {
                }
                column(RemitToAdd3; RemitToAdd3)
                {
                }
                ...
                dataitem(CurrencyLoop; "Integer")
                {
                    ...
                    dataitem(CustLedgEntryHdr; "Integer")
                    {
                        ...
                        dataitem(DtldCustLedgEntries; "Detailed Cust. Ledg. Entry")
                        {
                            ...
                            column(DocAppliesTo_DtldCustLedgEntries; AppliedDocType)
                            {
                            }
                            column(DocNoAppliesTo_DtldCustLedgEntries; AppliedDocNo)
                            {
                            }
