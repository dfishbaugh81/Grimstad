report 50102 "Sales Order Acknowledgement"
{
    RDLCLayout = './layouts/StandardSalesOrderAck.rdl';
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(CompanyLegalStatement; FooterStatement)
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    if "Promised Delivery Date" <> 0D then pDate:="Promised Delivery Date"
                    else
                        pDate:="Shipment Date";
            ...
            begin
                ...
                if DshipPackOptions.Get("No.")then PayAccNo:=DshipPackOptions."Payment Account No."
                else
                    PayAccNo:='';
    ...
    var SalesConfirmationLbl: Label 'Order Confirmation';
    ...
    PromiseDateLbl: Label 'Promise Date';
    ...
    FooterStatement: Label 'Ongoing price increases and surcharges may affect the final invoiced cost of this product. Customers will be notified before final shipment. Listed promise dates are an estimate and are subject to change due to supply chain volatility. For a copy of the J.M. Grimstad Inc. Terms & Conditions of Sale visit: http://www.grimstad.com/terms';
