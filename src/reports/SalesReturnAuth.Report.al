report 50113 "Sales Return Auth."
{
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/SalesReturnAuth.rdl';
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PaymentTermsDescription; "Sales Header"."Payment Terms Code")
                    {
                    }
                    ...
                    dataitem(SalesLine; "Integer")
                    {
                        ...
                        column(ItemReferenceNo; TempSalesLine."Item Reference No.")
                        {
                        }
                        trigger OnAfterGetRecord()
                        begin
 ...
 Clear(CopyTxt)
            ...
            begin
                ...
                SalesHeaderComment.SetRange("Print On Return Authorization", true);
