report 50114 "Purch. Return Order"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/PurchReturnOrder.rdl';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(SalesPersonPurchEmail; SalesPurchPerson."E-Mail")
                    {
                    }
                    ...
                    dataitem(DimensionLoop1; "Integer")
                    {
                        ...
                        begin
                            ...
                            Continue:=false;
                            repeat OldDimText_DimensionLoop1:=DimText_DimensionLoop1;
                                if DimText_DimensionLoop1 = '' then DimText_DimensionLoop1:=StrSubstNo('%1 %2', DimSetEntry1."Dimension Code", DimSetEntry1."Dimension Value Code")
                                else
                                    DimText_DimensionLoop1:=StrSubstNo('%1, %2 %3', DimText_DimensionLoop1, DimSetEntry1."Dimension Code", DimSetEntry1."Dimension Value Code");
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        dataitem(DimensionLoop2; "Integer")
                        {
                            ...
                            begin
                                ...
                                Continue:=false;
                                repeat OldDimText_DimensionLoop1:=DimText_DimensionLoop1;
                                    if DimText_DimensionLoop1 = '' then DimText_DimensionLoop1:=StrSubstNo('%1 %2', DimSetEntry2."Dimension Code", DimSetEntry2."Dimension Value Code")
                                    else
                                        DimText_DimensionLoop1:=StrSubstNo('%1, %2 %3', DimText_DimensionLoop1, DimSetEntry2."Dimension Code", DimSetEntry2."Dimension Value Code");
                                    if StrLen(DimText_DimensionLoop1) > MaxStrLen(OldDimText_DimensionLoop1)then begin
                                        DimText_DimensionLoop1:=OldDimText_DimensionLoop1;
                                        Continue:=true;
                                        exit;
                        ...
                        trigger OnAfterGetRecord()
                        begin
                            if Number = 1 then TempPurchaseLine.Find('-')
                            else
            ...
            begin
                ...
                if not Vend.Get("Buy-from Vendor No.")then Clear(Vend);
            end;
            trigger OnPostDataItem()
            begin
