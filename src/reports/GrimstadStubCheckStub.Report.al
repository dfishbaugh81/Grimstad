Report 50105 "Grimstad Stub/Check/Stub"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/GrimstadStubCheckStub.rdl';
        ...
        dataitem(GenJnlLine; "Gen. Journal Line")
        {
            ...
            dataitem(CheckPages; "Integer")
            {
                ...
                dataitem(PrintSettledLoop; "Integer")
                {
                    ...
                    trigger OnPreDataItem()
                    begin
                        PrintCheckHelper.PrintSettledLoopHelper(CustLedgEntry, VendLedgEntry, GenJnlLine, BalancingType.AsInteger(), BalancingNo, FoundLast, TestPrint, FirstPage, FoundNegative, ApplyMethod);
                ...
                begin
                    if not TestPrint then begin
                        ...
                        begin
                            ...
                            if BalancingType <> BalancingType::"G/L Account" then GenJnlLine3.Description:=StrSubstNo(Text014, SelectStr(BalancingType.AsInteger() + 1, Text062), BalancingNo);
    ...
    var Text000: Label 'Preview is not allowed.';
    ...
    procedure ExchangeAmt(PostingDate: Date; CurrencyCode: Code[10]; CurrencyCode2: Code[10]; Amount: Decimal)Amount2: Decimal begin
    ...
    local procedure CheckGenJournalBatchAndLineIsApproved(GenJournalLine: Record "Gen. Journal Line"): Boolean var
    ...
    local procedure VerifyRecordIdIsApproved(RecordID: RecordID): Boolean var
