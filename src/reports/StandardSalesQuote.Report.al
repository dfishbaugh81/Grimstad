report 50107 "Standard Sales Quote"
{
    RDLCLayout = './layouts/StandardSalesQuote.rdl';
    Caption = 'Sales - Quote';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Header; "Sales Header")
        {
            ...
            column(LabelBullet1; LabelBullet1)
            {
            }
            column(LabelBullet2; LabelBullet2)
            {
            }
            ...
            dataitem(Line; "Sales Line")
            {
                ...
                begin
                    ...
                    SalesCommentLine.SetRange("Print On Quote", true);
    ...
    FooterStatement: Label 'For a copy of the J.M. Grimstad Inc. Terms & Conditions of Sale visit: http://www.grimstad.com/terms';
