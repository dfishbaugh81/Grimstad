report 50112 "Purchase Quote"
{
    DefaultLayout = RDLC;
    RDLCLayout = './layouts/PurchQuote.rdl';
        ...
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Location; "Purchase Header"."Location Code")
                    {
                    }
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        column(Uom_PurchLine; "Unit of Measure Code")
                        {
                        }
            ...
            begin
                ...
                if not CurrReport.Preview then begin
                    ...
                    if LogInteraction then begin
                        ...
                        SegManagement.LogDocument(11, "No.", "Doc. No. Occurrence", "No. of Archived Versions", DATABASE::Vendor, "Pay-to Vendor No.", "Purchaser Code", '', "Posting Description", '');
                    end;
                end;
                UseDate:=WorkDate();
            end;
